#!/usr/bin/env python3
"""Figure 6: cation-dependent hydration and RH-local effort."""
import argparse
...
SYSTEMS=('Na-LC0.40', 'K-LC0.40', 'Ca-LC0.40')
def main():
    ...
    rows=load_csv("fig6_cation_sampling.csv"); apply_style(); fig,axes=plt.subplots(1,2,figsize=(7.0,2.65),constrained_layout=True); width=0.055
    ...
    axes[0].set_title("(a)",loc="left",fontweight="bold",pad=3); axes[1].set_title("(b)",loc="left",fontweight="bold",pad=3); axes[0].legend(loc="upper right"); save_outputs(fig,"fig6")
